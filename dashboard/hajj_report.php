...
<div class="container">
  ...
  <script>
    ...
    {
      $.ajax({
        url: 'ajax.hajj_report3.edit.php',
        type: 'POST',
        data: "id="+id,
      })
      .done(function(data) {
    ...
    function collect(id){
  	...
  	function deletes(id)
  	{
  		$(".delete").html("আপনি কি সত্যি এই ফাইলটি ডিলিট করতে চান ? <br> Hide: আপনি এই ফাইলটি ডিলিট করলে কোন তথ্য এদিক সেদিক হবে না। তথ্যটি রিপোর্ট এ জমা থাকবে । <br> Delete: আপনার এই ফাইল সংক্রান্ত যাবতীয় তথ্য ডিলিট হয়ে যাবে ।");
  		$(".delete").dialog({
  			open: true,
  			modal: true,
  			title: "Confirmation",
